...
const Results: React.FC<ResultsProps> = ({ results, onReset }) => {
  ...
  return (
    <div className="fade-in space-y-8">
      {/* Grade Display */}
      <div
        className={`card text-center text-white bg-gradient-to-r ${getGradeColor(
          results.grade
        )}`}
      >
        <div className="flex items-center justify-center mb-4">
          ...
          <div>
            ...
            <p className="text-xl opacity-90">
              امتیاز: {Math.round(results.finalScore)}
            </p>
          </div>
        </div>
      </div>
        ...
        {Object.entries({
          ...
          return (
            <div key={key} className="card text-center">
              <div
                className={`inline-flex items-center justify-center w-12 h-12 rounded-full ${scoreInfo.bgColor} mb-4`}
              >
